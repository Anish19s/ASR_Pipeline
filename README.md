...
│
├── asrpipeline.ipynb
│   └── Colab experimentation, testing, chunking & Whisper exploration
│
├── local.py
│   └── Local microphone-based live transcription
│
├── asr_deploy/
│   │
│   ├── app.py
│   │   └── FastAPI routes & API setup
│   │
│   ├── model.py
│   │   └── Whisper model loading & inference logic
│   │
│   └── requirements.txt
│
└── README.md
